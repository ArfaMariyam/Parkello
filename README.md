...
* **Phase 2 (Current):** I am currently implementing the mathematical calculations via using the variables like `totalAmount`, `totalVehicles`, `bikeCount`, and `carCount` and actively modifying them to track arrivals and departures in real-time.
* **Phase 3:** The 3rd phase will be about adding the authentication mechanism for the operator to login using username and password.
...
# How to run and test
I compiled a ready-to-run `index.exe` file which anyone can download by clicking [--> here <--](https://github.com/ArfaMariyam/Programming-fundamentals-in-CPP/releases) and just double-click it to run and test.